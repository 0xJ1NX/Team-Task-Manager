    ...
    <main>
        ...
        <div class="cards-container">
            ...
            <div class="card">
                ...
                <div class="card-text">
                    ...
                    $sql = "SELECT * FROM tasks WHERE assigned_to  = '$current_id' ";
            ...
            <div class="card">
                ...
                <div class="card-text">
                    <?php
                    $sql = "SELECT * FROM tasks WHERE status = 1 AND assigned_to  = '$current_id' ";
                    $result = $conn->query($sql);
                    $num_rows = $result->rowCount();
                    echo "<h3>$num_rows</h3>";
                    ?>
            ...
            <div class="card">
                ...
                <div class="card-text">
                    <?php
                    $sql = "SELECT * FROM tasks WHERE status = 0 AND assigned_to  = '$current_id'";
                    $result = $conn->query($sql);
                    $num_rows = $result->rowCount();
                    echo "<h3>$num_rows</h3>";
            ...
            <div class="card">
                ...
                <div class="card-text">
                    <?php
                    $sql = "SELECT * FROM tasks WHERE status = 3 AND assigned_to  = '$current_id'";
                    $result = $conn->query($sql);
                    $num_rows = $result->rowCount();
                    echo "<h3>$num_rows</h3>";
                    ?>
        ...
        <div class="table-container">
            ...
            <table id="mainTable">
                ...
                $user_id = $_SESSION['id'];
                $today = date('Y-m-d');
                $sql = "SELECT * FROM tasks WHERE assigned_to = '$user_id' AND due_date = '$today' ORDER BY priority DESC";
                $res = $conn->query($sql);
                ...
                if ($res->rowCount() > 0) {
                    while ($row = $res->fetch()) {
                        ...
                        <tr>
                            ...
                            <?php
                                //if task status is 0, then it is pending
                            ...
                            <td>
                                <?php
                                    if ($row['status'] == 0){
                                        ?>
                                        <a href="pendingTasksPage.php" class="button-blue">view</a>
                                        <?php
                                    } else if ($row['status'] == 1){
                                        ?>

                                        <a href="activeTasksPage.php" class="button-blue">view</a>

                                        <?php
                                    }else if ($row['status'] == 2){
                                        ?>
                                        <a href="completedTasksPage.php" class="button-blue">view</a>
                                        <?php
                                    }
                                    else if ($row['status'] == 3){
                                        ?>
                                        <a href="lateTasksPage.php" class="button-blue">view</a>
                                        <?php
                                    }
