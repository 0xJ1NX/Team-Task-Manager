...
if (isset($_POST['add'])) {
    ...
    $query = "INSERT INTO tasks (title, description,start_date, due_date, priority, assigned_to, assigned_by) VALUES ('$taskName', '$taskDescription', '$currentDate', '$dueDate', '$taskPriority', '$taskTo', '$currentUserID')";
    $res = $conn->query($query);

    if ($res) {
        header("Location: newTaskPage.php?success=Task added successfully");
    } else {
        header("Location: newTaskPage.php?error=Error adding task");
    }
...
<html lang="en">
<head>
    <title>Create New Task Page</title>
...
<div class="main-elements" >
    ...
    <main>
        ...
        <div class="create-cont">
            ...
            <form method="post" action="" class="createNewTask">
